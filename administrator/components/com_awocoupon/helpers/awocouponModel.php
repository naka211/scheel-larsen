...
if(version_compare( JVERSION, '3.0.0', 'ge' )) {
	class AwoCouponModelConnector extends JModelLegacy { }
}
...
class AwoCouponModel extends AwoCouponModelConnector {
	...
	function __construct() {
		...
		$this->_layout = JRequest::getWord('layout', 'default');
		$extra = ($this->_layout=='default' || $this->_layout=='edit') ? '' : $this->_layout;
		$limitstart = JFactory::getApplication()->getUserStateFromRequest( 'com_awocoupon.'.$this->_type.$extra.'.limitstart', 'limitstart', 0, 'int' );
