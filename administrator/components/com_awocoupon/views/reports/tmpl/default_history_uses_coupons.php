...
$labels = array(JText::_('COM_AWOCOUPON_CP_COUPON_CODE'),JText::_('COM_AWOCOUPON_GBL_ID'),JText::_('COM_AWOCOUPON_GBL_USERNAME'),
			JText::_('COM_AWOCOUPON_GBL_LAST_NAME').' 2',JText::_('COM_AWOCOUPON_GBL_FIRST_NAME'),JText::_('COM_AWOCOUPON_CP_DISCOUNT'),
			JText::_('COM_AWOCOUPON_GC_ORDER_NUM'),JText::_('COM_AWOCOUPON_RPT_ORDER_DATE'),JText::_('COM_AWOCOUPON_RPT_ORDER_TOTAL'),
			JText::_('COM_AWOCOUPON_RPT_SUBTOTAL'),JText::_('COM_AWOCOUPON_RPT_TAX_TOTAL'),JText::_('COM_AWOCOUPON_CP_SHIPPING'),
			JText::_('COM_AWOCOUPON_RPT_TAX_SHIPPING'),JText::_('COM_AWOCOUPON_RPT_FEE'));
$columns = array('coupon_code_str','user_id','username','last_name','first_name','discountstr','order_number','order_date',
				'order_total','order_subtotal','order_tax','order_shipment','order_shipment_tax','order_fee');
...
<center>
<div><font size="5"><?php echo JText::_('COM_AWOCOUPON_CP_HISTORY_USES').' - '.JText::_('COM_AWOCOUPON_CP_COUPONS'); ?></font></div>
...
<form action="index.php" method="post" name="adminForm">
	...
	<tr><td><INPUT TYPE="image" onclick="submitform('exportreports');" NAME="submit" src="<?php echo com_awocoupon_ASSETS;?>/images/excel.gif" border="0" alt="Export CSV">
			<font size="4"><?php echo JText::_('COM_AWOCOUPON_CP_HISTORY_USES').' - '.JText::_('COM_AWOCOUPON_CP_COUPONS'); ?></font>
	</td></tr>
	...
	<INPUT type="hidden" name="filename" value="history_uses_coupons_<?php if(!empty($this->start_date)) { echo str_replace('-','',$this->start_date).'-'.str_replace('-','',$this->end_date); } ?>.csv">
