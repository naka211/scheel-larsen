...
$labels = array(JText::_('COM_AWOCOUPON_CP_COUPON_CODE'),JText::_('COM_AWOCOUPON_CP_PRODUCT'),JText::_('COM_AWOCOUPON_CP_VALUE'),JText::_('COM_AWOCOUPON_CP_EXPIRATION'),
			JText::_('COM_AWOCOUPON_RPT_USER_ID'),JText::_('COM_AWOCOUPON_GBL_USERNAME'),
			JText::_('COM_AWOCOUPON_GBL_LAST_NAME'),JText::_('COM_AWOCOUPON_GBL_FIRST_NAME'),JText::_('COM_AWOCOUPON_GBL_EMAIL'),
			JText::_('COM_AWOCOUPON_GC_ORDER_NUM'),JText::_('COM_AWOCOUPON_RPT_ORDER_DATE'),JText::_('COM_AWOCOUPON_RPT_ORDER_TOTAL'),);
$columns = array('coupon_code','product_name','coupon_valuestr','expiration','user_id','username','last_name','first_name','email','order_number','order_date','order_total',);
...
<center>
<div><font size="5"><?php echo JText::_('COM_AWOCOUPON_RPT_PURCHASED_GIFTCERT'); ?></font></div>
...
<form action="index.php" method="post" name="adminForm">
	...
	<tr><td><INPUT TYPE="image" onclick="submitform('exportreports');" NAME="submit" src="<?php echo com_awocoupon_ASSETS;?>/images/excel.gif" border="0" alt="Export CSV">
			<font size="4"><?php echo JText::_('COM_AWOCOUPON_RPT_PURCHASED_GIFTCERT'); ?></font>
	</td></tr>
	...
	<INPUT type="hidden" name="filename" value="purchased_giftcert_list<?php if(!empty($this->start_date)) { echo str_replace('-','',$this->start_date).'-'.str_replace('-','',$this->end_date); } ?>.csv">
