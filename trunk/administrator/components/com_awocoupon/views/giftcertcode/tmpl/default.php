...
<div class="m">
<ul class="submenu">
	<li><a href="index.php?option=com_awocoupon&view=giftcert"><?php echo JText::_( 'COM_AWOCOUPON_GC_PRODUCTS' ); ?></a></li>
	<li><span class="active nolink"><?php echo JText::_( 'COM_AWOCOUPON_GC_CODES' ); ?></span></li>
</ul>
<div class="clr"></div>
</div>
...
<form action="index.php" method="post" id="adminForm" name="adminForm">
	...
	<thead>
		<tr>
			...
			<th class="title"><?php echo JHTML::_('grid.sort', 'COM_AWOCOUPON_GC_CODES', 'g.code', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			<th class="title"><?php echo JHTML::_('grid.sort', 'COM_AWOCOUPON_RPT_STATUS', 'g.status', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			<th class="title"><?php echo JHTML::_('grid.sort', 'COM_AWOCOUPON_CP_ADMIN_NOTE', 'g.note', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
	...
	<tbody>
		...
		<tr class="row<?php echo ($i%2); ?>">
			...
			<td align="left"><?php echo $row->_product_name; ?></td>
			<td align="center"><?php echo $row->code; ?></td>
			<td align="center"><?php echo $this->AWOCOUPON_lang['status'][$row->status]; ?>&nbsp;</td>
