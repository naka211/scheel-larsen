...
<br/><br/>
<iframe frameborder="0" width="100%" height="350" src="https://www.daycounts.com/component/versions/?catid=<?php echo $this->config->versioncat; ?>&tmpl=component&myVersion=<?php echo $this->config->version; ?>"></iframe>
